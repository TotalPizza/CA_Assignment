...
```{r}
FallAlter$Altersgruppe <- stringr::str_replace_all(NachBundesland$Altersgruppe, "[A]", "")
FallAlter$Altersgruppe <- stringr::str_replace_all(NachBundesland$Altersgruppe, "[-]", "")
